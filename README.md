...
```
Scripts for automating virtual infrastructure in the Tuxtech.com lab.
* ESXi Configuration
...
`ansible-playbook tuxtech-main.yml --tags os_10 --limit web2.tuxtech.com --skip-tags os_provision,os_config,role_config
`
